...
namespace Bank
{
    class Program
    {
        ...
        private static void InserirConta()
        {
            ...
            Console.WriteLine("Digite 1 - Conta Física ou 2 - Conta Jurídica: ");
            int entradaTipoConta = int.Parse(Console.ReadLine());

            Console.WriteLine("Digite o nome do cliente: ");
            string entradaNome = Console.ReadLine();

            Console.WriteLine("Digite o saldo inicial da cota R$: ");
            double entradaSaldo = double.Parse(Console.ReadLine());

            Console.WriteLine("Digite o valor do crédito R$: ");
        ...
        {
            Console.WriteLine();
            Console.WriteLine("BankDio a seu dispor!!");
